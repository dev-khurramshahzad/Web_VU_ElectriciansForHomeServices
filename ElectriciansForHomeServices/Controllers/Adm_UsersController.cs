...
namespace ElectriciansForHomeServices.Controllers
{
    public class Adm_UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserID,Name,Phone,Address,Email,Password,CNIC,Details,Status,Image,Type")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserID,Name,Phone,Address,Email,Password,CNIC,Details,Status,Image,Type")] User user)
        {
            if (ModelState.IsValid)
            {
